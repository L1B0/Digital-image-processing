...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget5->setGeometry(QRect(30, 400, 991, 271));
        horizontalLayout_11 = new QHBoxLayout(layoutWidget5);
        horizontalLayout_11->setSpacing(6);
        horizontalLayout_11->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_11->setObjectName(QStringLiteral("horizontalLayout_11"));
        horizontalLayout_11->setContentsMargins(0, 0, 0, 0);
        line_trans_image = new QLabel(layoutWidget5);
        ...
        line_trans_paint = new QCustomPlot(layoutWidget5);
        ...
        line_ori_paint = new QCustomPlot(layoutWidget6);
        ...
        layoutWidget7->setGeometry(QRect(350, 360, 301, 41));
        ...
        line_f1 = new QLabel(layoutWidget7);
        ...
        line_b1 = new QLineEdit(layoutWidget7);
        ...
        line_push = new QPushButton(layoutWidget7);
